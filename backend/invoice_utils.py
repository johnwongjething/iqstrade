...
def send_invoice_email(to_email, subject, body, pdf_path):
    ...
    try:
        ...
        # Attaching PDF from: {local_pdf_path} as {attachment_filename}
    ...
    try:
        ...
        for bl in bl_numbers:
            ...
            if row:
                ...
                pass  # No invoice found for BL in database
    except Exception as e:
