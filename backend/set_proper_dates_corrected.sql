-- Set Proper Dates for Payment Records (CORRECTED)
-- created_at = When customer uploads file
-- payment_85_percent_date = When 85% payment received (Allinpay only)
...
UPDATE bill_of_lading 
SET payment_85_percent_date = '2025-07-13 10:00:00',
...
UPDATE bill_of_lading 
SET payment_85_percent_date = '2025-07-16 14:30:00',
...
UPDATE bill_of_lading 
SET payment_85_percent_date = '2025-07-20 08:45:00',
...
UPDATE bill_of_lading 
SET payment_85_percent_date = '2025-07-10 14:00:00',
    completed_at = NULL
WHERE payment_method = 'Allinpay' 
  AND status = 'Paid and CTN Valid'
...
UPDATE bill_of_lading 
SET payment_85_percent_date = '2025-07-12 09:30:00',
    completed_at = NULL
WHERE payment_method = 'Allinpay' 
  AND status = 'Paid and CTN Valid'
  AND reserve_status = 'Unsettled'
...
UPDATE bill_of_lading 
SET payment_85_percent_date = '2025-07-14 16:15:00',
    completed_at = NULL
WHERE payment_method = 'Allinpay' 
  AND status = 'Paid and CTN Valid'
  AND reserve_status = 'Unsettled'
...
UPDATE bill_of_lading 
SET payment_85_percent_date = '2025-07-17 11:45:00',
    completed_at = NULL
WHERE payment_method = 'Allinpay' 
  AND status = 'Paid and CTN Valid'
  AND reserve_status = 'Unsettled'
...
SELECT 
    ...
    CASE 
        ...
        WHEN payment_method = 'Allinpay' AND reserve_status = 'Reserve Settled' THEN '85% on payment_85_percent_date, 15% on completed_at'
        WHEN payment_method = 'Allinpay' AND reserve_status = 'Unsettled' THEN '85% on payment_85_percent_date, 15% pending'
        ELSE 'Other'
