#!/usr/bin/env python3
"""
Send New Complex Email Templates Automatically - Fixed Version
Uses correct SMTP settings from .env.local
"""
...
def send_complex_emails():
    ...
    # Email configuration - Use SMTP settings from .env.local
    sender_email = os.getenv('EMAIL_USERNAME')  # ray6330088@gmail.com
    sender_password = os.getenv('EMAIL_PASSWORD')  # gfpv lggj wsmo cgri
    ...
    print("\n🚀 Sending New Complex Email Templates")
    print("=" * 50)
...
def main():
    """Main function"""
    print("📧 New Complex Email Sender - Fixed Version")
    print("=" * 40)
